...
def main(split, protocol, eval_p):
    ...
    with open(
        f"{os.environ['DATA_DIR']}/arctic/data/arctic_data/data/splits_json/protocol_{protocol}.json", "r"
    ) as f:
    ...
    out_folder = f"{os.environ['DATA_DIR']}/arctic/data/arctic_data/data/feat"
