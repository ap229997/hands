...
class Ego4DGraspDataset(Dataset):
    def __init__(self, args, mode='test') -> None:
        ...
        filename = f"{os.environ['DATA_DIR']}/ego4d_hands/grasp_ego.pkl"
        ...
        logger.info("# of samples in Ego4D Grasp %s: %d" % (mode, len(self.subsampled_keys)))
