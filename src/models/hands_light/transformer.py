...
class TransformerEncoder(Module):
    ...
    def forward(self, src: Tensor, mask: Optional[Tensor] = None, src_key_padding_mask: Optional[Tensor] = None, **kwargs) -> Tensor:
        ...
        for mod in self.layers:
            output = mod(output, src_mask=mask, src_key_padding_mask=src_key_padding_mask_for_layers, **kwargs)
...
class TransformerEncoderLayer(Module):
    ...
    def forward(self, src: Tensor, src_mask: Optional[Tensor] = None,
        ...
        elif isinstance(self.norm1, LayerNorm) and isinstance(self.norm2, LayerNorm) and (not (self.norm1.eps == self.norm2.eps)):
        ...
        no_norm = kwargs.get('no_norm', False)
        if no_norm:
