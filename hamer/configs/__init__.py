...
CACHE_DIR_HAMER = os.environ['CACHE_DIR_HAMER']
...
def get_config(config_file: str, merge: bool = True, update_cachedir: bool = False) -> CN:
    ...
    if update_cachedir:
      ...
      cfg.MANO.DATA_DIR = update_path(cfg.MANO.DATA_DIR)
      cfg.MANO.MODEL_PATH = update_path(cfg.MANO.MODEL_PATH)
      cfg.MANO.MEAN_PARAMS = update_path(cfg.MANO.MEAN_PARAMS)
      cfg.MODEL.BACKBONE.PRETRAINED_WEIGHTS = update_path(cfg.MODEL.BACKBONE.PRETRAINED_WEIGHTS)
