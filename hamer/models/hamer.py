...
class HAMER(pl.LightningModule):
    ...
    def __init__(self, cfg: CfgNode, init_renderer: bool = True):
        ...
        # if cfg.MODEL.BACKBONE.get('PRETRAINED_WEIGHTS', None): # backbone params are already in the hamer checkpoint, don't need to load separately
    ...
    def configure_optimizers(self) -> Tuple[torch.optim.Optimizer, torch.optim.Optimizer]:
        ...
        return optimizer
        # return optimizer, optimizer_disc # this shouldn't work without the self.cfg.LOSS_WEIGHTS.ADVERSARIAL > 0 condition
    ...
    def forward_step(self, batch: Dict, train: bool = False) -> Dict:
        ...
        output['pred_keypoints_2d'] = pred_keypoints_2d.reshape(batch_size, -1, 2) # these are in [-0.5,0.5], specific to cfg.MODEL.IMAGE_SIZE
        return output
